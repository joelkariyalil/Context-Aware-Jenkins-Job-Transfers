...
def test_check_plugin_dependencies_quiet_negative(jenkinsCreds):
    """
    Test check_plugin_dependencies() function in quiet mode with no plugin dependencies.
    ...
    try:
        ...
        logger.error(f"Error in test_check_plugin_dependencies_quiet_negative: {e}")
...
def test_check_plugin_dependencies_quiet_positive(jenkinsCreds):
    ...
    try:
        ...
        logger.error(f"Error in test_check_plugin_dependencies_quiet_positive: {e}")
...
def test_check_plugin_dependencies_console_negative(jenkinsCreds, capsys):
    """
    Test check_plugin_dependencies() function in console mode with no plugin dependencies.

    Verifies that the check_plugin_dependencies() function does not detect any plugins when
    ...
    try:
        ...
        logger.error(f"Error in test_check_plugin_dependencies_console_negative: {e}")
...
def test_check_plugin_dependencies_console_positive(jenkinsCreds, capsys):
    ...
    try:
        ...
        logger.error(f"Error in test_check_plugin_dependencies_console_positive: {e}")
